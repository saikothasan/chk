...
<div class="card col-sm-8">
  <h5 class="card-body h6">TELESWAG BRAINTEE CHK</h5>
  <div class="card-body">
    <center><span>LEGIT CHECKER</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">CARD LIST</label>
</div>
</div>
<center>
 <button class="btn btn-primary" style="width: 200px; outline: none;" id="testar" onclick="enviar()" >CHECK</button>
...
<div class="card col-sm-2">
  ...
  <div class="card-body">
  	<span>Status:</span><span class="badge badge-secondary"> WAIT FOR COMMAND.</span>
<div class="md-form">
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Made by TELESWAG:
      <a href="https://discordapp.com/"> @Binneros#1800</a>
    </div>
